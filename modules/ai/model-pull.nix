# Pre-pull a curated set of model artifacts at activation time.
#
# Real implementation will use a `huggingface-cli` systemd timer; the
# stub registers the option surface today.
{ config, lib, ... }:
{
